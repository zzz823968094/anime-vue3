      ...
      <div class="hero-inner">
        <template v-if="loading">
          <div class="cover-card">
            <div class="sh" style="width:192px;height:270px;border-radius:14px;"/>
          </div>
          <div class="info-wrap">
      ...
      <div class="sec">
        ...
        <div v-else class="ep-wrap">
          ...
          <div class="ep-page on">
            ...
            >{{ t.epLabel }}{{ v.episode }}{{ t.epSuffix }}
            </button>
          </div>
        </div>
      </div>
...
async function load() {
  ...
  try {
    ...
    document.title = `${anime.value?.vodName} - ${t.value.siteName}`
